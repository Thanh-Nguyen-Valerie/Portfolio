...
const styles = {
  "pages/index.vue": () => import('./index-styles.DSEGwNed.mjs').then(interopDefault),
  "pages/index.vue?vue&type=style&index=0&scoped=86e8d6c0&lang.css": () => import('./index-styles.DSEGwNed.mjs').then(interopDefault),
